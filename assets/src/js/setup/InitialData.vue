    ...
    <div>
        ...
        <form @submit.prevent="submit">
            ...
            <div class="md:flex md:items-center mt-2">
                ...
                <div class="md:w-2/3">
                    <input v-model="form.admin_email" class="bg-grey-lighter appearance-none border border-grey-lighter hover:border-blue rounded w-full py-2 px-4 text-grey-darker" name="admin_email" id="admin_email" type="email" placeholder="JaneDoe@example.com" required>
            ...
            <div class="md:flex md:items-center mt-2">
                ...
                <div class="md:w-2/3">
                    <input v-model="form.admin_password" class="bg-grey-lighter appearance-none border border-grey-lighter hover:border-blue rounded w-full py-2 px-4 text-grey-darker" name="admin_password" id="admin_password" type="password" placeholder="" required>
            ...
            <div class="md:flex md:items-center mt-2">
                ...
                <div class="md:w-2/3">
                    <input v-model="form.branding_name" class="bg-grey-lighter appearance-none border border-grey-lighter hover:border-blue rounded w-full py-2 px-4 text-grey-darker" name="branding_name" id="branding_name" type="text">
            ...
            <div class="md:flex md:items-center mt-2">
                ...
                <div class="md:w-2/3">
                    <input v-model="form.branding_tagline" class="bg-grey-lighter appearance-none border border-grey-lighter hover:border-blue rounded w-full py-2 px-4 text-grey-darker" name="branding_tagline" id="branding_tagline" type="text">
            ...
            <div class="md:flex md:items-center mt-2">
                ...
                <div class="md:w-2/3">
                    <input v-model="form.branding_logo" class="bg-grey-lighter appearance-none border border-grey-lighter hover:border-blue rounded w-full py-2 px-4 text-grey-darker" name="branding_logo" id="branding_logo" type="text" placeholder="https://example.com/images/logo.svg">
            ...
            <div class="md:flex md:items-center mt-2">
                ...
                <div class="md:w-2/3">
                    <input v-model="form.quarantine_report_from" class="bg-grey-lighter appearance-none border border-grey-lighter hover:border-blue rounded w-full py-2 px-4 text-grey-darker" name="quarantine_report_from" id="quarantine_report_from" type="email" placeholder="postmaster@example.com" required>
            ...
            <div class="md:flex md:items-center mt-2">
                ...
                <div class="md:w-2/3">
                    <input v-model="form.quarantine_report_subject" class="bg-grey-lighter appearance-none border border-grey-lighter hover:border-blue rounded w-full py-2 px-4 text-grey-darker" name="quarantine_report_subject" id="quarantine_report_subject" type="text">
