        ...
        <div class="w-full max-w-sm">
            ...
            <form @submit.prevent="submit" class="bg-white shadow-lg sm:rounded px-8 pt-6 pb-8 mb-4" method="POST">
                ...
                <div class="md:flex md:items-center mb-6">
                    ...
                    <div class="md:w-2/3">
                        <input v-model="form.password" class="form-input border-1 bg-gray-100 text-sm border-gray-100 pl-4 pr-4 text-gray-900 rounded w-full my-1" name="password" id="password" type="password" placeholder="******************" required>
                ...
                <div class="md:flex md:items-center mb-2" v-if="form.errors.has('two_factor_token') && !use_backup_code">
                    <div class="md:w-1/3">
                    <label class="block text-gray-700 font-bold md:text-right mb-1 md:mb-0 pr-4" for="two_factor_token">
                        Two Factor Verification
                    </label>
                    </div>
                    <div class="md:w-2/3">
                        <input v-model="form.two_factor_token" class="form-input border-1 bg-gray-100 text-sm border-gray-100 pl-4 pr-4 text-gray-900 rounded w-full my-1" name="two_factor_token" id="two_factor_token" type="text" required>
                ...
                <div class="md:flex md:items-center mb-6" v-if="form.errors.has('two_factor_token') && !use_backup_code">
                    ...
                    <div class="md:w-2/3">
                        <button type="button" class="inline-block align-baseline text-sm text-blue-500 hover:text-blue-800" @click.prevent="use_backup_code = true" v-if="form.errors.has('two_factor_token')">Use 2FA Backup code</button>
                    </div>
                </div>
                <div class="md:flex md:items-center mb-2" v-if="form.errors.has('two_factor_token') && use_backup_code">
                    <div class="md:w-1/3">
                    <label class="block text-gray-700 font-bold md:text-right mb-1 md:mb-0 pr-4" for="backup_code">
                        2FA Backup Code
                    </label>
                    </div>
                    <div class="md:w-2/3">
                        <input v-model="form.backup_code" class="form-input border-1 bg-gray-100 text-sm border-gray-100 pl-4 pr-4 text-gray-900 rounded w-full my-1" name="backup_code" id="backup_code" type="text" required>
                ...
                <div class="flex flex-row-reverse items-center justify-between">
                    ...
                    <router-link class="inline-block align-baseline text-sm text-blue-500 hover:text-blue-800" to="/password-reset">
                        Forgot Password?
                    </router-link>
                </div>
            </form>
