    ...
    <div class="sm:container mx-auto sm:px-4 pt-6 pb-8">
        <div class="card p-2">
            <div v-if="user.is_staff">
                <h2 class="p-1 pb-0 font-extralight text-lg text-gray-800">Import SMTP relays</h2>
                <hr>
                <p class="prose-sm">
                    Use the form below to import data about which servers are allowed to send mail through this service
                </p>
                ...
                <p class="prose-sm">
                    ...
                    <ol class="list-decimal pl-8">
                        <li>IP-address</li>
                        <li>Hostname (Must match the PTR-record of the IP)</li>
                        <li>Active</li>
                        <li>Comments (Any note to fx. define why the entry is there or who it belongs to)</li>
                    </ol>
...
export default {
    ...
    methods: {
        ...
        submit() {
            ...
            formData.append('import_type', 'smtp_relay');
