                ...
                <div class="mx-auto px-4">
                    <div class="flex items-center lg:justify-between">
                        ...
                        <div class="w-1/2 hidden sm:block lg:w-auto text-center text-white text-xl font-medium">
                            <img v-if="appLogo" :src="appLogo" class="h-10"/>
                        ...
                        <div class="w-3/4 sm:w-auto flex justify-end text-right h-full text-gray-500 py-3">
                            ...
                            <a :href="config.app_feedback" class="text-gray-500 hover:text-white pr-3 transition duration-300" target="_blank" title="Give feedback">
                                <mg-feedback-icon class="w-6 h-6"></mg-feedback-icon>
                            </a>
                            <router-link to="/profile" class="text-gray-500 hover:text-white pr-3 transition duration-300" title="Your account">
                                <mg-account-circle-icon class="w-6 h-6"></mg-account-circle-icon>
                            </router-link>
                            <div class="hover:text-white cursor-pointer transition duration-300" @click="logout" title="Log out">
