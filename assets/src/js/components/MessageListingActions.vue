<template>
    <div>
        <div class="pt-2">
            ...
            <div class="pb-1">
                <button @click="allowlist_modal" class="bg-white hover:bg-blue-500 text-blue-600 font-semibold hover:text-white py-1 px-2 border border-blue-500 hover:border-transparent text-xs rounded shadow">
            ...
            <div>
                <button @click="blocklist_modal" class="bg-white hover:bg-blue-500 text-blue-600 font-semibold hover:text-white py-1 px-2 border border-blue-500 hover:border-transparent text-xs rounded shadow">
                    <div class="inline-flex content-center">
...
export default {
    ...
    methods: {
        blocklist_modal() {
            listing_modal('blocked');
        },
        allowlist_modal() {
            listing_modal('allowed');
        },
