...
import MessageContents from '../pages/Messages/Contents.vue';
...
export default [
    ...
    { path: '/messages/:uuid/content', component: MessageContents, name: 'messages.detail.content', props: true, meta: { requiresAuth: true } },
