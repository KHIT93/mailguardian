...
def setup_deb(pkg_mgr, os_release, os_version):
    ...
    os.system('cd /tmp; wget https://github.com/MailScanner/v5/releases/download/5.5.1-1/MailScanner-5.5.1-1.noarch.deb')
    os.system('cd /tmp; dpkg -i MailScanner-5.5.1-1.noarch.deb')
...
def setup_rhel(pkg_mgr, os_release, os_version):
    ...
    os.system('{pkg} install https://github.com/MailScanner/v5/releases/download/5.5.1-1/MailScanner-5.5.1-1.rhel.noarch.rpm -y'.format(pkg=PKG_MGR))
