...
CPAN_DEPS = ['CPAN', 'Data::Dumper', 'Data::UUID', 'HTTP::Date', 'DBI', 'Encode::FixLatin', 'Digest::SHA1', 'Mail::ClamAV', 'Mail::SpamAssassin::Plugin::SPF', 'Mail::SpamAssassin::Plugin::URIDNSBL', 'Mail::SpamAssassin::Plugin::DNSEval', 'Encoding::FixLatin']
PKG_MGR = False
...
def setup_deb(pkg_mgr, os_release, os_version):
    ...
    os.system('cd /tmp; wget https://github.com/MailScanner/v5/releases/download/5.4.1-2/MailScanner-5.4.1-2.noarch.deb')
    os.system('cd /tmp; dpkg -i MailScanner-5.4.1-2.noarch.deb')
...
def setup_rhel(pkg_mgr, os_release, os_version):
    ...
    os.system('{pkg} install https://github.com/MailScanner/v5/releases/download/5.4.1-2/MailScanner-5.4.1-2.rhel.noarch.rpm -y'.format(pkg=PKG_MGR))
