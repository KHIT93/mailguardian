        ...
        <template #header>
            <div class="flex items-start gap-4">
                <div class="inline-flex">
                    <UIcon name="i-heroicons-information-circle-solid" class="text-red-600 w-10 h-10" />
                </div>
                <div>
                    <p class="text-gray-900 dark:text-white font-semibold text-base">
                        Recent spam hits
                    </p>
                    <div class="mt-1 text-gray-500 dark:text-gray-400 text-sm">Messages from these domains have recently been flagged</div>
                </div>
            </div>
        </template>
...
<script setup>
    const endpoint = computed(() => '/dashboard/spammers')
