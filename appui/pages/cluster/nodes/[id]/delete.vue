<template>
    <MainLayout>
        ...
        <div class="shadow overflow-hidden sm:rounded-md">
            <UCard>
                <template #header>
                    <h1 class="text-xl">Delete host ({{ id }})?</h1>
                </template>
                <p>
                    Are you absoutely certain that you wish to delete this host?<br/>
...
useHead({
    title: 'MailGuardian - Delete Host'
})
...
async function submit() {
    await form.delete(`/api/hosts/${id}/`)
